...
void GCLContext::init_vulkan_instance() {
...
void GCLContext::init_vulkan_physical_device() {
...
void GCLContext::init_vulkan_logical_device() {
...
void GCLContext::init_vma_allocator() {
